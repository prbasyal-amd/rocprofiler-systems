...
`source/lib/rocprof-sys/library/sampling.cpp <https://github.com/ROCm/rocprofiler-systems/blob/amd-staging/source/lib/rocprof-sys/library/sampling.cpp>`_.
Within `sampling.cpp <https://github.com/ROCm/rocprofiler-systems/blob/amd-staging/source/lib/rocprof-sys/library/sampling.cpp>`_,
there is a bundle of three sampling components:

* `backtrace_timestamp <https://github.com/ROCm/rocprofiler-systems/blob/amd-staging/source/lib/rocprof-sys/library/components/backtrace_timestamp.hpp>`_ simply
  records the wall-clock time of the sample.
* `backtrace <https://github.com/ROCm/rocprofiler-systems/blob/amd-staging/source/lib/rocprof-sys/library/components/backtrace.hpp>`_
  records the call-stack via libunwind.
* `backtrace_metrics <https://github.com/ROCm/rocprofiler-systems/blob/amd-staging/source/lib/rocprof-sys/library/components/backtrace_metrics.hpp>`_
